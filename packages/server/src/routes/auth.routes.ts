...
authRouter.get('/me', requireAuth, async (req, res, next) => {
  try {
    ...
    // Same artist-profile lookup as auth.service.publicUser so clients can
    // tell "this is my artist page" and hide self-only affordances (e.g.
    // the follow pill on their own card).
